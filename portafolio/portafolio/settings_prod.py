...
SECRET_KEY = 'django-insecure-+uu@$i8#^8o75rifgxwy6gmazlmd&704uc-y4^3rj=hon=q)b1'
...
#para que reconozca la carpeta "media" que esta a la altura de las app y el proyecto
MEDIA_URL = "/media/"
